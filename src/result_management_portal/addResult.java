...
public class addResult extends javax.swing.JFrame {
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        if(rs.next()){
            st.executeUpdate("insert into result(rollnumber,physics,Maths,EM,DBMS,OS) values('"+roll+"','"+physics+"','"+Maths+"','"+EM+"','"+DBMS+"','"+OS+"')");
                   javax.swing.JOptionPane.showMessageDialog(null,"Marks Saved successfully!"); 
                   setVisible(false);
                   new addResult().setVisible(true);
            ...
            javax.swing.JOptionPane.showMessageDialog(null,"This roll number is not registered!"); 
